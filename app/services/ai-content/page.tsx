// app/services/ai-powered-content-creation/page.tsx (Server Component)
...
export const metadata = {
  title: 'AI-Powered Content Creation | Netonline Media',
  description: 'Discover AI-powered content creation solutions from Netonline Media. Produce high-quality content at scale that matches your brand voice and engages your audience.',
  keywords: 'AI content creation, AI-powered content, automated content production, content generation AI, brand consistency AI, AI content tools, content creation services London, content automation',
  openGraph: {
    type: 'website',
    url: 'https://netonlinemedia.com/ai-powered-content-creation',
    title: 'AI-Powered Content Creation | Netonline Media',
    description: 'Discover AI-powered content creation solutions from Netonline Media. Produce high-quality content at scale that matches your brand voice and engages your audience.',
  },
  ldJson: {
    ...
    description: 'Scale your content production with AI-powered tools that ensure consistency and creativity across all platforms.',
    areaServed: 'UK',
    offers: {
      '@type': 'Offer',
      priceCurrency: 'GBP',
