...
export const metadata = {
  ...
  keywords: 'AI Chatbots, LLM-Based Chatbots, AI-powered chatbots, 24/7 chatbot support, automated customer service, intelligent chatbots, conversational AI, chatbot UK, chatbot London',
  openGraph: {
    type: 'website',
    url: 'https://netonlinemedia.com/ai-chatbots',
    title: 'AI-Powered Chatbots | Netonline Media',
    description: 'Discover AI-powered chatbots from Netonline Media that transform customer service with 24/7 support, fast response times, and efficiency.',
  },
};
