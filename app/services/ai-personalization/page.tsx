// app/services/ai-personalization/page.tsx (Server Component)
...
export const metadata = {
  title: 'AI-Driven Personalization | Netonline Media',
  description: 'Deliver personalized experiences with Netonline Media\'s AI-driven personalization services. Tailor each customer\'s experience for increased engagement and conversions.',
  keywords: 'AI personalization, AI-driven experiences, personalized product recommendations, AI in marketing, AI customer engagement, real-time personalization, UK AI solutions, AI personalization tools',
  openGraph: {
    type: 'website',
    url: 'https://netonlinemedia.com/ai-personalization',
    title: 'AI-Driven Personalization | Netonline Media',
    description: 'Deliver personalized experiences with Netonline Media\'s AI-driven personalization services. Tailor each customer\'s experience for increased engagement and conversions.',
  },
  ldJson: {
    ...
    description: 'Create tailored AI-driven customer experiences that enhance engagement and drive conversions.',
    areaServed: 'UK',
    offers: {
      '@type': 'Offer',
      priceCurrency: 'GBP',
