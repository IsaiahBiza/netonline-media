// app/services/custom-generative-ai/page.tsx (Server Component)
...
export const metadata = {
  title: 'Custom Generative AI Solutions | Netonline Media',
  description: 'Netonline Media offers tailored generative AI solutions designed to meet specific business needs. Automate workflows and scale efficiently with custom AI models.',
  keywords: 'Custom AI solutions, generative AI, AI automation, AI content generation, AI business solutions, UK AI solutions, AI for businesses',
  openGraph: {
    type: 'website',
    url: 'https://netonlinemedia.com/custom-generative-ai',
    title: 'Custom Generative AI Solutions | Netonline Media',
    description: 'Netonline Media offers tailored generative AI solutions designed to meet specific business needs. Automate workflows and scale efficiently with custom AI models.',
  },
  ldJson: {
    ...
    description: 'Tailored AI solutions that automate and scale your business operations.',
    areaServed: 'UK',
    offers: {
      '@type': 'Offer',
      priceCurrency: 'GBP',
