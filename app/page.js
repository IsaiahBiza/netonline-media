...
export default function Home() {
  return (
    <>
      <Head>
        <meta name="description" content="Netonline Media offers AI-powered business solutions including custom AI models, content creation, chatbots, and personalization services." />
        <meta name="keywords" content="AI solutions, AI business services, generative AI, content creation, AI chatbots, AI personalization" />
